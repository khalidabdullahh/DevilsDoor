...
```mermaid
graph TD
    Repo["⛩️ DevilsDoor Repository"] --> Part1["📄 Part 1: MIT Permissive License"]
    Repo --> Part2["🔒 Part 2: Commercial Proprietary License (All Rights Reserved)"]
    
    Part1 --> Engine["Game Engine Framework & Mechanics"]
    Part1 --> Scripts["Build & Test Utilities"]
    
    Part2 --> IP1["Trademarks ('Devil's Door', 'Aurex')"]
    Part2 --> IP2["6 Playable Hero Models & Sprites"]
    Part2 --> IP3["4K Shrine Background Assets"]
    Part2 --> IP4["Procedural Audio & Game Lore"]
```
